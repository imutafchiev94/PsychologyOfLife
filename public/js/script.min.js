$(document).ready(function () {
  $("[data-bs-hover-animate]")
    .mouseenter(function () {
      var o = $(this);
      o.addClass("animated " + o.attr("data-bs-hover-animate"));
    })
    .mouseleave(function () {
      var o = $(this);
      o.removeClass("animated " + o.attr("data-bs-hover-animate"));
    });
}),
  (function (o) {
    "use strict";
    ...
    a(),
      ...
      o(document).ready(function () {
        o(".dropdown-toggle").hover(function () {
          o(".dropdown-menu").slideToggle();
        });
      });
  })(jQuery);
